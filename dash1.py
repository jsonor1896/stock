...
def normalize(vals):
    vals.reverse()
    m = max(vals)
    return [round(val / m, 6) for val in vals]
...
app.layout = html.Div([
    dcc.Checklist(
        id='my-codes',
        options=[
            {'label': 'ETF50', 'value': '510050'},
            {'label': 'ETF300', 'value': '510300'},
            {'label': 'ETF500', 'value': '510500'},
            {'label': '科技ETF', 'value': '515000'},
            {'label': '证券ETF', 'value': '512880'},
            {'label': '生物医药ETF', 'value': '512290'},
            {'label': '创业ETF50', 'value': '159949'},
        ],
        value=['510050', '510300', '510500', '515000',
               '512880', '512290', '159949']
    ),
    html.Div('510050 ETF50'),
    dcc.Graph(id='510050'),
    html.Div('510300 ETF300'),
    dcc.Graph(id='510300'),
    html.Div('510500 ETF500'),
    dcc.Graph(id='510500'),
    html.Div('515000 科技ETF'),
    dcc.Graph(id='515000'),
    html.Div('512880 证券ETF'),
    dcc.Graph(id='512880'),
    html.Div('512290 生物医疗'),
    dcc.Graph(id='512290'),
    html.Div('159949 创业50'),
    dcc.Graph(id='159949')
], style={'width': '500'})
...
@app.callback(
    [
        Output('510050', 'figure'),
        Output('510300', 'figure'),
        Output('510500', 'figure'),
        Output('515000', 'figure'),
        Output('512880', 'figure'),
        Output('512290', 'figure'),
        Output('159949', 'figure'),
    ],
    [
        Input('my-codes', 'value')
    ]
)
def update_graph(codes):
    ...
    return data['510050'], data['510300'], data['510500'], data['515000'], data['512880'], data['512290'], data[
        '159949']
